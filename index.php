...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg bg-white shadow-sm">
        <div class="container px-5">
            <a class="navbar-brand fs-4" href="#">Gwork</a>
    ...
    <div class="container">
        <div class="mt-5 p-3 d-flex flex-column align-items-center">
            <span class="fs-4"><b class="text-primary fs-3">123123</b> sprawdzonych ofert pracy</span>
            <span class="fs-5">od najlepszych pracodawców!</span>
        </div>

        <h3 class="mt-5 text-primary">Szukaj ofert:</h3>
